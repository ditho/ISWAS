...
(function(){
    ...
    ProgressListener.EXPORTED_SYMBOLS= ["QueryInterface","onLinkIconAvailable","onLocationChange",
    "onProgressChange","onRefreshAttempted","onSecurityChange","onStateChange","onStatusChange"];
    ...
    (function(){
        ...
        function onLocationChange(webProgress, request, location) {
            ...
            if(content.document.readyState == "complete" || !_hasChanged()) {
