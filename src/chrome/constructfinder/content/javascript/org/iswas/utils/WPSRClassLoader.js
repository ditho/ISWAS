...
(function(){
    ...
    (function(){
        ...
        function load(ns) {
            ...
            //var classLoader = "file:///" + _extPath.path.replace(/\\/g, "/") + "/java/javaFirefoxExtensionUtils.jar"; // TODO: uncommand for build prod.xpi
            var classLoader = "file:///C:/Dokumente%20und%20Einstellungen/tb006/Eigene%20Dateien/NetBeansProjects/ISWAS/src/java/javaFirefoxExtensionUtils.jar";
            ...
            // the line below have to be uncomment for the prod version of the firefox extension
            //var jarPath = "file:///" + _extPath.path.replace(/\\/g, "/") + "/java/wpsr.jar"; // TODOD: uncommand for build prod.xpi
            var jarPath = "file:///C:/Dokumente%20und%20Einstellungen/tb006/Eigene%20Dateien/NetBeansProjects/ISWAS/src/java/wpsr.jar";
